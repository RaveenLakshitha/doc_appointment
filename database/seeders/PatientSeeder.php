...
class PatientSeeder extends Seeder
{
    ...
    {
        $faker = Faker::create(); // English names, addresses, phones
        ...
        for ($i = 0; $i < 35; $i++) {
            ...
            $dob = $faker->dateTimeBetween('-80 years', '-5 years');
            ...
            Patient::create([
                ...
                // Removed fields (receive_lab_results, consent_hipaa, etc.) as they are not in the Patient model

                // === System ===
                'medical_record_number' => 'MRN' . $faker->unique()->numerify('#######'),
