...
<div class="px-4 sm:px-6 lg:px-4 pb-4 sm:py-12 pt-20">
    <div class="mb-8">
        <div class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-3">
            ...
            <span class="text-gray-900 dark:text-white">{{ __('file.edit_prescription') }}</span>
        </div>
                ...
                <div id="content-patient" class="tab-content">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="diagnosis" rows="3" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow resize-none">{{ old('diagnosis', $prescription->diagnosis) }}</textarea>
                            ...
                            @forelse($prescription->medications as $index => $med)
                                <div class="medication-row grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                                    <div class="md:col-span-3">
                                        ...
                                        <input type="text" name="medications[{{ $index }}][name]" value="{{ old("medications.$index.name", $med->name) }}" required class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                                    </div>
                                    <div class="md:col-span-2">
                                        <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.dosage') }}</label>
                                        <input type="text" name="medications[{{ $index }}][dosage]" value="{{ old("medications.$index.dosage", $med->dosage) }}" required placeholder="{{ __('file.dosage_ph') }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <select name="medications[{{ $index }}][route]" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                            ...
                                            <option value="Topical" {{ old("medications.$index.route", $med->route) == 'Topical' ? 'selected' : '' }}>{{ __('file.topical') }}</option>
                                            <option value="Sublingual" {{ old("medications.$index.route", $med->route) == 'Sublingual' ? 'selected' : '' }}>{{ __('file.sublingual') }}</option>
                                        </select>
                                    </div>
                                    <div class="md:col-span-2">
                                        <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.frequency') }}</label>
                                        <input type="text" name="medications[{{ $index }}][frequency]" value="{{ old("medications.$index.frequency", $med->frequency) }}" required placeholder="{{ __('file.frequency_ph') }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                                    </div>
                                    <div class="md:col-span-2">
                                        <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.duration_days') }}</label>
                                        <input type="number" name="medications[{{ $index }}][duration_days]" value="{{ old("medications.$index.duration_days", $med->duration_days) }}" min="1" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                                    </div>
