...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white mb-1">{{ number_format($inventoryitem->current_stock) }}</div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white mb-1">Rs. {{ number_format($inventoryitem->unit_cost, 2) }}</div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="text-3xl font-bold text-green-600 dark:text-green-400 mb-1">Rs. {{ number_format($inventoryitem->unit_price, 2) }}</div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white mb-1">Rs. {{ number_format($inventoryitem->total_value, 2) }}</div>
