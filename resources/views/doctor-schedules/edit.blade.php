            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="time" name="start_time" value="{{ old('start_time', $doctorSchedule->start_time->format('H:i')) }}" required
                               class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg 
                    ...
                    <div>
                        ...
                        <input type="time" name="end_time" value="{{ old('end_time', $doctorSchedule->end_time->format('H:i')) }}" required
                               class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg 
                                      focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent 
                                      dark:bg-transparent dark:text-white transition-shadow">
                        @error('end_time')
                ...
                <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" name="valid_from" value="{{ old('valid_from', $doctorSchedule->valid_from?->format('Y-m-d')) }}"
                                   class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg 
                                          focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent 
                        ...
                        <div>
                            ...
                            <input type="date" name="valid_until" value="{{ old('valid_until', $doctorSchedule->valid_until?->format('Y-m-d')) }}"
                                   class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg 
                                          focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent 
                                          dark:bg-transparent dark:text-white [color-scheme:light] dark:[color-scheme:dark] transition-shadow">
                            @error('valid_until')
