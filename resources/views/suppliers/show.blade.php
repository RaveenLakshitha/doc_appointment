        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex-1">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span class="px-2.5 py-1 text-xs border rounded
                ...
                <div class="p-5 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $supplier->email }}" class="text-sm text-gray-900 dark:text-white hover:underline">
                                {{ $supplier->email }}
                            </a>
                        </div>
                        @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div>
                            ...
                            <a href="{{ $supplier->website }}" target="_blank" class="text-sm text-gray-900 dark:text-white hover:underline">
                                {{ $supplier->website }}
                            </a>
                        </div>
                        @endif
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-900">
                            <tr>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.item') }}</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.sku') }}</th>
                                <th class="px-5 py-3 text-right text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.current_stock') }}</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <td class="px-5 py-3">
                                    <a href="{{ route('inventory.show', $item) }}" class="text-sm text-gray-900 dark:text-white hover:underline">
                                        {{ $item->name }}
                                    </a>
                                </td>
                                <td class="px-5 py-3 text-sm text-gray-600 dark:text-gray-400">{{ $item->sku ?? '—' }}</td>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-900">
                            <tr>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.item') }}</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.supplier_item_code') }}</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.price') }}</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.moq') }}</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.lead_time') }}</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-3 text-sm text-gray-900 dark:text-white">
                                    Rs. {{ number_format($item->pivot->supplier_price ?? 0, 2) }}
                                </td>
                                <td class="px-5 py-3 text-sm text-gray-900 dark:text-white">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        ...
                        @else
                            <span class="px-2.5 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded text-gray-500 dark:text-gray-400">
                                {{ __('file.inactive') }}
                            </span>
                        @endif
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5 space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-lg font-medium text-gray-900 dark:text-white">{{ $supplier->inventoryItems->count() }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-700 dark:text-gray-300">{{ __('file.secondary_items') }}</span>
                        <span class="text-lg font-medium text-gray-900 dark:text-white">{{ $supplier->secondaryItems->count() }}</span>
                    </div>
                </div>
            </div>
