            ...
            <table id="attendance-table" class="w-full divide-y divide-gray-200 dark:divide-gray-700 display nowrap" style="width:100%">
                <thead class="bg-gray-50 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-4 sm:px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">{{ __('file.clock_in') }}</th>
                        <th class="px-4 sm:px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">{{ __('file.clock_out') }}</th>
                        ...
                        <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">{{ __('file.notes') }}</th>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const table = $('#attendance-table').DataTable({
        ...
        columns: [
            ...
            { data: 'notes', render: data => data ? `<span class="text-gray-600 dark:text-gray-400 text-sm">${data}</span>` : '-' },
            {
                data: null,
                orderable: false,
                searchable: false,
