...
<div class="px-4 sm:px-6 lg:px-4 pb-4 sm:py-12 pt-20">
    ...
    <form method="POST" action="{{ route('prescriptions.store') }}" class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                @if(isset($appointment))
                                    <div class="w-full px-3 py-2.5 text-sm font-medium bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white">
                                        {{ $appointment->patient->getFullNameAttribute() }}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="medicine_template_id" id="selected-template-id" value="{{ old('medicine_template_id') }}">
                            </div>
                        </div>
                        ...
                        <div id="medications-container" class="space-y-4">
                            <div class="medication-row grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="medications[0][dosage]" required placeholder="{{ __('file.dosage_ph') }}" 
                                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white">
                                </div>
                                <div class="md:col-span-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="medications[0][frequency]" required placeholder="{{ __('file.frequency_ph') }}" 
                                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white">
                                </div>
                                <div class="md:col-span-2">
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-6">
            <button type="submit" 
                    class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow-sm transition">
...
document.getElementById('add-medication').addEventListener('click', function () {
    ...
    const template = `
        <div class="medication-row grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
            <div class="md:col-span-3">
                <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.medication_name') }} <span class="text-red-500">*</span></label>
                <input type="text" name="medications[${medicationIndex}][name]" required class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white">
            </div>
            <div class="md:col-span-2">
                <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.dosage') }} <span class="text-red-500">*</span></label>
...
document.getElementById('template-select').addEventListener('change', function () {
    ...
    if (!templateId) {
        ...
        container.innerHTML = `
            <div class="medication-row grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                <!-- same first row structure as above -->
            ...
            meds.forEach((med, index) => {
                const row = `
                    <div class="medication-row grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                        <div class="md:col-span-3">
                            <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.medication_name') }} <span class="text-red-500">*</span></label>
                            <input type="text" name="medications[${index}][name]" value="${med.name}" required class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">{{ __('file.dosage') }} <span class="text-red-500">*</span></label>
