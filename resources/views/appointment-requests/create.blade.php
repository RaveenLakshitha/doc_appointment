            ...
            <div class="p-6">
                <div class="space-y-8">
                    ...
                    <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div id="specific-doctor-field" class="mt-6 {{ old('doctor_selection_mode') == 'specific' ? '' : 'hidden' }}">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <input type="date" name="requested_date" value="{{ old('requested_date') }}" required min="{{ now()->format('Y-m-d') }}"
                            ...
                            <div>
                                ...
                                <input type="time" name="requested_start_time" value="{{ old('requested_start_time') }}" required
                                       class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="time" name="preferred_time_range_start" value="{{ old('preferred_time_range_start') }}"
                                       class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                ...
                                <input type="time" name="preferred_time_range_end" value="{{ old('preferred_time_range_end') }}"
                                       class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="duration_minutes" required
                                        class="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent transition-all">
                                    <option value="15" {{ old('duration_minutes', 30) == 15 ? 'selected' : '' }}>15 {{ __('file.minutes') }}</option>
                                    <option value="30" {{ old('duration_minutes', 30) == 30 ? 'selected' : '' }}>30 {{ __('file.minutes') }}</option>
                                    <option value="45" {{ old('duration_minutes', 30) == 45 ? 'selected' : '' }}>45 {{ __('file.minutes') }}</option>
                                    <option value="60" {{ old('duration_minutes', 30) == 60 ? 'selected' : '' }}>60 {{ __('file.minutes') }}</option>
                                    <option value="90" {{ old('duration_minutes', 30) == 90 ? 'selected' : '' }}>90 {{ __('file.minutes') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="reason_for_visit" rows="4" required placeholder="{{ __('file.reason_for_visit_placeholder') }}"
