                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $patient->date_of_birth?->format('Y-m-d')) }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white [color-scheme:light] dark:[color-scheme:dark] transition-shadow">
                            ...
                            <div>
                                ...
                                <input type="number" name="age" value="{{ old('age', $patient->age) }}" min="0" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow" placeholder="e.g. 30">
                        ...
                        <div>
                            ...
                            <select name="preferred_contact_method" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow">
                                ...
                                <option value="whatsapp" {{ old('preferred_contact_method', $patient->preferred_contact_method) == 'whatsapp' ? 'selected' : '' }}>{{ __('file.whatsapp') }}</option>
                                ...
                                <div>
                                    ...
                                    <select name="age_group_id" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                        ...
                                        @foreach($ageGroups as $group)
                                            <option value="{{ $group->id }}" {{ old('age_group_id', $patient->age_group_id) == $group->id ? 'selected' : '' }}>
                                                {{ $group->name }}
                                ...
                                <div>
                                    ...
                                    <select name="preferred_language_id" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                        ...
                                        @foreach($languages as $id => $name)
                                            <option value="{{ $id }}" {{ old('preferred_language_id', $patient->preferred_language_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="tax_id" value="{{ old('tax_id', $patient->tax_id) }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow" placeholder="{{ __('file.tax_id') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="tax_full_name" value="{{ old('tax_full_name', $patient->tax_full_name) }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow" placeholder="{{ __('file.tax_full_name') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="tax_postal_code" value="{{ old('tax_postal_code', $patient->tax_postal_code) }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow" placeholder="{{ __('file.tax_postal_code') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="tax_regime" value="{{ old('tax_regime', $patient->tax_regime) }}" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow" placeholder="{{ __('file.tax_regime') }}">
                            ...
                            <div>
                                ...
                                <select name="tax_invoice_usage" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                    ...
                                    @foreach($cfdiOptions as $code => $langKey)
                                        <option value="{{ $code }}" {{ old('tax_invoice_usage', $patient->tax_invoice_usage) == $code ? 'selected' : '' }}>
                                            {{ __($langKey) }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    @if($patient->tax_cfdi_path)
                                        <div class="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400">
                                            <a href="{{ asset($patient->tax_cfdi_path) }}" target="_blank" class="text-blue-600 hover:text-blue-500 flex items-center">
                                                <i class="fas fa-file-pdf mr-1"></i> {{ __('file.view_current_cfdi') }}
                                            </a>
                                        </div>
                                    @endif
                                </div>
