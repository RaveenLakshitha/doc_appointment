                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}" required class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow" placeholder="{{ __('file.phone_placeholder') }}">
...
function switchTab(tabName) {
    ...
    document.querySelectorAll('.tab-button').forEach(btn => {
        btn.classList.remove(
            ...
            'border-b-2', 'border-gray-900', 'dark:border-gray-400',
