                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $doctor->date_of_birth?->format('Y-m-d')) }}"
                        ...
                        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="emergency_contact_name" value="{{ old('emergency_contact_name', $doctor->emergency_contact_name ?? '') }}"
                                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow"
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('file.phone') }}</label>
                                    <input type="text" name="emergency_contact_phone" value="{{ old('emergency_contact_phone', $doctor->emergency_contact_phone ?? '') }}"
                                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-white transition-shadow"
                                           placeholder="{{ __('file.phone_placeholder') }}">
                    ...
                    <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="primary_specialization_id" required
                                    ...
                                    @foreach($specializations as $specialization)
                                        <option value="{{ $specialization->id }}" {{ old('primary_specialization_id', $doctor->primary_specialization_id) == $specialization->id ? 'selected' : '' }}>
                                            {{ $specialization->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                @error('age_group_ids.*') <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('language_ids.*') <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                            </div>
                        </div>
                                ...
                                <div id="treatment-repeater" class="space-y-4">
                                        ...
                                        @foreach($doctor->treatments as $index => $treatment)
                                            <div class="flex flex-col sm:flex-row gap-4 items-end treatment-row">
                                                <div class="flex-1">
                                                    ...
                                                    <select name="treatments[{{ $index }}][id]" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    ...
                                    @else
                                        <div class="flex flex-col sm:flex-row gap-4 items-end treatment-row">
                                            ...
                                            <div class="flex-1">
                                                <label class="block text-xs text-gray-500 dark:text-gray-400">Price</label>
                                                <input type="number" name="treatments[0][price]" step="0.01" min="0" required
                                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                       placeholder="0.00">
                                            </div>
                                            <button type="button" class="remove-row text-red-600 hover:text-red-800 text-sm mt-6">Remove</button>
...
document.getElementById('add-treatment-row')?.addEventListener('click', function () {
    ...
    newRow.innerHTML = `
        <div class="flex-1">
            <label class="block text-xs text-gray-500 dark:text-gray-400">Treatment</label>
            <select name="treatments[${treatmentIndex}][id]" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                <option value="">-- Select Treatment --</option>
                @foreach($treatments as $treatment)
                    <option value="{{ $treatment->id }}">{{ $treatment->name }} ({{ $treatment->code ?? '—' }})</option>
                @endforeach
        ...
        <div class="flex-1">
            <label class="block text-xs text-gray-500 dark:text-gray-400">Price</label>
            <input type="number" name="treatments[${treatmentIndex}][price]" step="0.01" min="0" required
                   class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        </div>
