        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex-1">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <span class="px-2.5 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded text-gray-700 dark:text-gray-300">
                        {{ $inventoryitem->sku }}
                    </span>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5 space-y-5">
                    ...
                    <div>
                        <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.description') }}</label>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $inventoryitem->description }}</p>
                    </div>
                    @endif

                    <!-- Stock & Pricing Summary -->
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('file.current_stock') }}</div>
                            <div class="text-xl font-semibold text-gray-900 dark:text-white">{{ number_format($inventoryitem->current_stock ?? 0) }}</div>
                        ...
                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            ...
                            <div class="text-xl font-semibold text-gray-900 dark:text-white">Rs. {{ number_format($inventoryitem->unit_cost ?? 0, 2) }}</div>
                        ...
                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            ...
                            <div class="text-xl font-semibold text-gray-900 dark:text-white">Rs. {{ number_format($inventoryitem->unit_price ?? 0, 2) }}</div>
                            @php
                                $margin = ($inventoryitem->unit_price && $inventoryitem->unit_cost) 
                                    ...
                                    : 0;
                            @endphp
                            <div class="text-xs text-gray-600 dark:text-gray-400">{{ number_format($margin, 1) }}% margin</div>
                        </div>

                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('file.total_value') }}</div>
                            @php
                                $totalValue = ($inventoryitem->current_stock ?? 0) * ($inventoryitem->unit_cost ?? 0);
                            @endphp
                            <div class="text-xl font-semibold text-gray-900 dark:text-white">Rs. {{ number_format($totalValue, 2) }}</div>
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div>
                            <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.unit_of_measure') }}</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $inventoryitem->unit_of_measure ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.unit_quantity') }}</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $inventoryitem->unit_quantity ?? 1 }}</p>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.manufacturer') }}</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $inventoryitem->manufacturer }}</p>
                            </div>
                            @endif
                            @if($inventoryitem->brand)
                            <div>
                                <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.brand') }}</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $inventoryitem->brand }}</p>
                            </div>
                            @endif
                            @if($inventoryitem->model_version)
                            <div>
                                <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.model_version') }}</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $inventoryitem->model_version }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <label class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">{{ __('file.storage_location') }}</label>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5">
                    <div class="mb-5">
                        <div class="flex justify-between items-end mb-2">
                            ...
                            <span class="text-sm text-gray-900 dark:text-white">
                                {{ $inventoryitem->current_stock ?? 0 }} / {{ $inventoryitem->maximum_stock_level ?: '∞' }}
                            </span>
                        </div>
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded h-2 overflow-hidden">
                            @php
                                $currentStock = $inventoryitem->current_stock ?? 0;
                                $maxStock = $inventoryitem->maximum_stock_level;
                                $reorderPoint = $inventoryitem->reorder_point ?? 0;
                                
                                $percentage = $maxStock 
                                    ? min(($currentStock / $maxStock) * 100, 100)
                                    : 50;
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('file.reorder_point') }}</div>
                            <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $inventoryitem->reorder_point ?? '—' }}</div>
                        </div>
                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('file.minimum_stock_level') }}</div>
                            <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $inventoryitem->minimum_stock_level ?: '—' }}</div>
                        </div>
                        <div class="text-center p-3 border border-gray-200 dark:border-gray-700 rounded">
                            <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('file.reorder_quantity') }}</div>
                            <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $inventoryitem->reorder_quantity ?: '—' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $inventoryitem->tax_rate }}%</div>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5 space-y-3">
                    <div class="p-4 border border-gray-200 dark:border-gray-700 rounded">
                        ...
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white mb-3">{{ $inventoryitem->primarySupplier->name }}</h3>
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Item Code</div>
                                <div class="text-sm text-gray-900 dark:text-white">{{ $inventoryitem->supplier_item_code ?: '—' }}</div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Price</div>
                                <div class="text-sm text-gray-900 dark:text-white">Rs. {{ number_format($inventoryitem->supplier_price ?? 0, 2) }}</div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Lead Time</div>
                                <div class="text-sm text-gray-900 dark:text-white">{{ $inventoryitem->lead_time_days ?? 0 }} days</div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Min. Order Qty</div>
                                <div class="text-sm text-gray-900 dark:text-white">{{ $inventoryitem->minimum_order_quantity ?? 0 }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-5">
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <dd class="text-sm text-gray-900 dark:text-white mt-1">{{ $inventoryitem->generic_name }}</dd>
                        </div>
                        @endif
                        @if($inventoryitem->medicine_type)
                        <div>
                            <dt class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">Medicine Type</dt>
                            <dd class="text-sm text-gray-900 dark:text-white mt-1">{{ $inventoryitem->medicine_type }}</dd>
                        </div>
                        @endif
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <dt class="text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">Precautions & Warnings</dt>
                        <dd class="text-sm text-gray-900 dark:text-white mt-1">{{ $inventoryitem->precautions_warnings }}</dd>
                    </div>
                    @endif
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-900">
                            <tr>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">Batch Number</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">Mfg. Date</th>
                                <th class="px-5 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">Expiry Date</th>
                                <th class="px-5 py-3 text-right text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">Quantity</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($inventoryitem->batches as $batch)
                            <tr>
                                <td class="px-5 py-3 text-sm text-gray-900 dark:text-white">{{ $batch->batch_number ?? 'N/A' }}</td>
                                <td class="px-5 py-3 text-sm text-gray-900 dark:text-white">{{ $batch->manufacturing_date ? $batch->manufacturing_date->format('Y-m-d') : 'N/A' }}</td>
                                <td class="px-5 py-3 text-sm text-gray-900 dark:text-white">{{ $batch->expiry_date ? $batch->expiry_date->format('Y-m-d') : 'N/A' }}</td>
                                <td class="px-5 py-3 text-right text-sm text-gray-900 dark:text-white">{{ $batch->current_quantity }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5 space-y-2">
                    <div class="flex items-center justify-between p-2.5 border border-gray-200 dark:border-gray-700 rounded">
                    ...
                    <div class="flex items-center justify-between p-2.5 border border-gray-200 dark:border-gray-700 rounded">
                        <span class="text-sm text-gray-700 dark:text-gray-300">{{ __('file.requires_refrigeration') }}</span>
                        <div class="flex items-center">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5">
                    <div class="space-y-2">
                        ...
                        <div class="text-sm text-gray-900 dark:text-white p-2.5 border border-gray-200 dark:border-gray-700 rounded">
                            {{ $condition }}
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="p-5">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <img src="{{ Storage::url($inventoryitem->medicine_image) }}" alt="Medicine" class="w-full rounded border border-gray-200 dark:border-gray-700">
                        </div>
                        @endif
                        @if($inventoryitem->package_image)
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Package Image</p>
                            <img src="{{ Storage::url($inventoryitem->package_image) }}" alt="Package" class="w-full rounded border border-gray-200 dark:border-gray-700">
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                <div class="px-5 py-3 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-base font-medium text-gray-900 dark:text-white">{{ __('file.additional_info') }}</h2>
                </div>
                <div class="p-5">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                ...
                <div class="p-5 space-y-2">
                    <button class="w-full flex items-center justify-center px-4 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm border border-gray-300 dark:border-gray-600 rounded hover:bg-gray-50 dark:hover:bg-gray-700">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
