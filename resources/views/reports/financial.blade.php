    ...
    <div id="report_content" class="hidden space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm">
                ...
                <div class="p-6 pt-0">
                    <div class="text-2xl font-bold" id="total_sales">$0</div>
                </div>
            </div>
            ...
            <div class="border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm">
                ...
                <div class="p-6 pt-0">
                    <div class="text-2xl font-bold text-green-600 dark:text-green-400" id="total_paid">$0</div>
                </div>
            </div>
            ...
            <div class="border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm">
                ...
                <div class="p-6 pt-0">
                    <div class="text-2xl font-bold text-orange-600 dark:text-orange-400" id="outstanding">$0</div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSummaryCards(summary) {
        document.getElementById('total_sales').textContent   = '$' + summary.total_sales;
        document.getElementById('total_paid').textContent    = '$' + summary.total_paid;
        document.getElementById('outstanding').textContent   = '$' + summary.outstanding;
        ...
        invoices.forEach(inv => {
            tbody.innerHTML += `
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 text-sm">$${inv.total}</td>
                    <td class="px-6 py-4 text-sm text-green-600">$${inv.paid}</td>
                    <td class="px-6 py-4 text-sm text-orange-600">$${inv.balance}</td>
                    <td class="px-6 py-4">
        ...
        payments.forEach(pmt => {
            tbody.innerHTML += `
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 text-sm font-medium text-green-600">$${pmt.amount}</td>
        ...
        invoices.forEach(inv => {
            tbody.innerHTML += `
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 text-sm font-medium text-orange-600">$${inv.balance}</td>
                </tr>
            `;
        });
    }
