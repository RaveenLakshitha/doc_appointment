    ...
    <div id="report_content" class="hidden space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm">
                <div class="p-6 flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-4a2 2 0 00-2 2v3m-8-5H4"></path>
                    </svg>
                </div>
                <div class="p-6 pt-0">
            ...
            <div class="border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm">
                ...
                <div class="p-6 pt-0">
                    <div class="text-2xl font-bold" id="inventory_value">$0</div>
                </div>
            </div>
        </div>
                ...
                <table class="w-full min-w-max">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Reorder Point</th>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSummaryCards(summary) {
        ...
        document.getElementById('inventory_value').textContent = '$' + Number(summary.inventory_value).toLocaleString();
    }
        ...
        items.forEach(item => {
            tbody.innerHTML += `
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">${item.reorder_point}</td>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">$${item.value}</td>
                </tr>
            `;
        });
    }
