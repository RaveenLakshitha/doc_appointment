            ...
            <table id="docapp-table" class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">{{ __('file.location') }}</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">{{ __('file.staff_count') }}</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">{{ __('file.services') }}</th>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div><label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.email') }}</label><div class="text-gray-900 dark:text-white" id="drawer-email"></div></div>
                        <div><label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.phone') }}</label><div class="text-gray-900 dark:text-white" id="drawer-phone"></div></div>
                        <div><label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.location') }}</label><div class="text-gray-900 dark:text-white" id="drawer-location"></div></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div><label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.staff_count') }}</label><div class="text-gray-900 dark:text-white" id="drawer-staff"></div></div>
                        <div><label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.services') }}</label><div class="text-gray-900 dark:text-white" id="drawer-services"></div></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div>
                            ...
                            <input type="email" name="email" id="edit-email" class="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 text-gray-900 dark:text-white" />
                        </div>
                        <div>
                            <label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.phone') }}</label>
                            <input type="text" name="phone" id="edit-phone" class="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 text-gray-900 dark:text-white" />
                        </div>
                        <div>
                            <label class="text-xs text-gray-500 dark:text-gray-400">{{ __('file.location') }}</label>
                            <input type="text" name="location" id="edit-location" class="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 text-gray-900 dark:text-white" />
                        </div>
                    </div>
                </div>
