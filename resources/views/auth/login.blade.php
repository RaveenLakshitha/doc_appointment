<x-guest-layout>
    ...
    <!-- Header with Logo / Initials + Clinic Name -->
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <!-- Password (your existing code with eye toggle) -->
        <div>
    ...
    <div x-data="{ show: false }" class="relative">
        ...
        <button 
            type="button"
            @click="show = !show"
            class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-500 hover:text-indigo-600 focus:outline-none cursor-pointer"
        >
