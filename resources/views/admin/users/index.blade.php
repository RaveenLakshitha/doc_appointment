                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    buttons: [
                                        ...
                                        { extend: 'excel', text: 'Excel', filename: 'Users_{{ date("Y-m-d") }}', exportOptions: { columns: ':not(.no-export)' } },
                                        { extend: 'csv', text: 'CSV', filename: 'Users_{{ date("Y-m-d") }}', exportOptions: { columns: ':not(.no-export)' } },
                                        { extend: 'pdf', text: 'PDF', filename: 'Users_{{ date("Y-m-d") }}', title: 'Users List', exportOptions: { columns: ':not(.no-export)' } },
