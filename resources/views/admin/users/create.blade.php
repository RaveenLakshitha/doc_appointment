...
<div class="px-4 sm:px-6 lg:px-4 pb-4 sm:py-12 pt-20">
    ...
    <form method="POST" action="{{ route('users.store') }}" class="space-y-8">
            ...
            <div class="p-6 sm:p-8 space-y-8">
                ...
                <div class="space-y-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                {{ __('file.confirm_password') ?? 'Confirm Password' }} <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                ...
                <div class="space-y-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        @foreach($roles as $role)
                            <label class="relative flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                                ...
                                <span class="absolute inset-0 rounded-lg pointer-events-none border-2 border-transparent group-has-[:checked]:border-gray-900 dark:group-has-[:checked]:border-gray-300 transition-all"></span>
                            </label>
                        @endforeach
                    </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-4">
            <button type="submit"
                    class="inline-flex items-center justify-center px-6 py-3 bg-gray-900 hover:bg-gray-800 
                           dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 text-white 
            ...
            <a href="{{ route('users.index') }}"
               class="inline-flex items-center justify-center px-6 py-3 bg-gray-100 hover:bg-gray-200 
                      dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-300 text-gray-700 
                      text-sm font-medium rounded-lg transition-colors border border-gray-300 dark:border-gray-600">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
