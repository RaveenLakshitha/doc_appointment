...
<div class="px-4 sm:px-6 lg:px-4 pb-4 sm:py-12 pt-20">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">{{ __('file.create_new_medicine_template') }}</h1>
    ...
    <form method="POST" action="{{ route('medicine-templates.store') }}" class="space-y-8">
        ...
        <div class="bg-white dark:bg-transparent rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6 space-y-10">
                ...
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="space-y-6">
                    <div class="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('file.medications') }}</h3>
                    ...
                    <div id="medications-container" class="space-y-4"
                        ...
                        <div class="medication-row grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="medications[0][route]" class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white">
