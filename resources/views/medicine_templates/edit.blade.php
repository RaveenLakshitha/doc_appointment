                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="category" value="{{ old('category', $medicineTemplate->category) }}"
                                    ...
                                    <select name="medications[{{ $index }}][inventory_item_id]" required
                                        ...
                                        @foreach($medicines as $medicine)
                                            <option value="{{ $medicine['id'] }}"
                                                {{ old("medications.$index.inventory_item_id", $medication->inventory_item_id) == $medicine['id'] ? 'selected' : '' }}>
                                                {{ $medicine['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="medications[{{ $index }}][route]"
                                        ...
                                        @foreach($routes as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old("medications.$index.route", $medication->route) == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
