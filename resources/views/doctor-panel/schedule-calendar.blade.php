...
<div class="px-4 sm:px-6 lg:px-8 pb-6 sm:py-12 pt-20">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Your recurring availability, assigned rooms, and active days</p>
        </div>
    </div>
...
<style>
    ...
    /* Hide weekday names in month view (same as admin) */
