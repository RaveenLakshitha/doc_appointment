...
class EmployeeController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        $data = $employees->map(function ($e) {
            ...
            return [
                'id'              => $e->id,
                'name'            => $e->full_name ?? '-', // Uses accessor
                ...
                'edit_url'        => route('employees.edit', $e),
                'delete_url'      => route('employees.destroy', $e),
            ];
        });
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $validated) {
            ...
            Employee::create([
                ...
                // Embedded qualification & license fields
    ...
    {
        $departments = Department::orderBy('name')->get();
        $users = User::doesntHave('employee')->orWhere('id', $employee->user_id)->orderBy('name')->get();
        $supervisors = Employee::where('id', '!=', $employee->id)->orderBy('first_name')->orderBy('last_name')->get();

        return view('employees.edit', compact('employee', 'departments', 'users', 'supervisors'));
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        Employee::whereIn('id', $ids)->update(['status' => false]);

        return back()->with('success', 'Selected employees deactivated successfully.');
    }
}